...
public class ContactProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChatContacts selected =(ChatContacts) fromChatContactActivity.getSerializableExtra("chat_contact");

        final TextView hellopage = (TextView) findViewById(R.id.hello_name_text);
        hellopage.setText(selected.getStatus());
    }
